...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-TBVBGALR.js";
import {
  ToggleButton_default
} from "./chunk-VDUWMAUY.js";
import {
  ButtonGroup_default
...
var Switch = React67.forwardRef((props, ref) => (0, import_jsx_runtime66.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Modal = React82.forwardRef(({
  ...
  const renderBackdrop = (0, import_react44.useCallback)((backdropProps) => (0, import_jsx_runtime81.jsx)("div", {
    ...backdropProps,
...
var NavbarCollapse = React87.forwardRef(({
  ...
  const context5 = (0, import_react46.useContext)(NavbarContext_default);
...
var NavbarOffcanvas = React89.forwardRef((props, ref) => {
  const context5 = (0, import_react48.useContext)(NavbarContext_default);
...
var NavbarText = React90.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React91.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
...
var NavDropdown = React92.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React93.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
  ...
  const [exited, setExited] = (0, import_react51.useState)(!props.show);
...
var PopoverHeader = React94.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React95.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React97.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Tooltip = React98.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Overlay2 = React99.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  const popperRef = (0, import_react53.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react53.useState)(null);
  ...
  return (0, import_jsx_runtime99.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React99.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react54.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react54.useRef)("");
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React100.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  const handleShow = (0, import_react54.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react54.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react54.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react54.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react54.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react54.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react54.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime102.jsxs)(import_jsx_runtime101.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react54.cloneElement)(children, triggerProps), (0, import_jsx_runtime100.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React101.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
...
function createButton(name, defaultValue, label = name) {
  const Button = React101.forwardRef(({
    children,
    ...props
...
var Pagination = React102.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
var PlaceholderButton = React103.forwardRef((props, ref) => {
...
var Placeholder = React104.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React105.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
  ...
  return (0, import_jsx_runtime108.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react55.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
var Ratio = React106.forwardRef(({
  ...
  return (0, import_jsx_runtime109.jsx)("div", {
    ...
    children: React106.Children.only(children)
  });
});
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react56.useContext)(TabContext_default);
  if (!context5)
  ...
  const {
    ...
    getControlledId,
    getControllerId
  } = context5, rest = _objectWithoutPropertiesLoose7(context5, _excluded22);
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react57.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react57.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var ToastHeader = React120.forwardRef(({
  ...
  const context5 = (0, import_react58.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React122.forwardRef(({
  ...
  const delayRef = (0, import_react59.useRef)(delay);
  const onCloseRef = (0, import_react59.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react59.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react59.useMemo)(() => ({
    onClose
  }), [onClose]);
